...
var _chunk3BA3276Bcjs = require('../chunk-3BA3276B.cjs');
require('../chunk-52VLPARL.cjs');
require('../chunk-VIIXOUMH.cjs');
require('../chunk-S5V43NLN.cjs');
...
async function circularRefs(definition) {
  const oas = new (0, _chunk3BA3276Bcjs.Oas)(JSON.parse(JSON.stringify(definition)));
