...
function getSchemaVersionString(schema, api) {
  if (!_chunkG6ASGSM5cjs.isOAS31.call(void 0, api)) {
...
function toJSONSchema(data, opts = {}) {
  ...
  const schemaAdditionalProperties = _chunkG6ASGSM5cjs.isSchema.call(void 0, schema) ? schema.additionalProperties : null;
  const {
  ...
  if (_chunkG6ASGSM5cjs.isRef.call(void 0, schema)) {
    refLogger(schema.$ref, "ref");
    return transformer({
      $ref: schema.$ref
    });
  }
  if (_chunkG6ASGSM5cjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild)) {
  ...
  if (_chunkG6ASGSM5cjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild)) {
    ...
    if (hasSchemaType(schema, "array")) {
      if ("items" in schema) {
        if (!Array.isArray(schema.items) && Object.keys(schema.items).length === 1 && _chunkG6ASGSM5cjs.isRef.call(void 0, schema.items)) {
  ...
  if (_chunkG6ASGSM5cjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild) && globalDefaults && Object.keys(globalDefaults).length > 0 && currentLocation) {
    try {
  ...
  if (_chunkG6ASGSM5cjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild) && "enum" in schema && Array.isArray(schema.enum)) {
